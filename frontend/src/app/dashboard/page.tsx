    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div className="scroll-animate scroll-fade-up scroll-scale scroll-stagger-1 group bg-white overflow-hidden shadow-lg rounded-2xl border border-[#b8c5d6]/30 hover:shadow-2xl hover:border-[#5b6fa3] transition-all duration-300 hover:-translate-y-1">
                    <div className="px-6 py-8 sm:p-8">
                        <div className="flex items-center">
                            <div className="shrink-0 bg-linear-to-br from-[#5b6fa3] to-[#b8c5d6] rounded-xl p-4 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                ...
                                <dd className="mt-2 text-4xl font-bold bg-linear-to-r from-[#22223b] to-[#5b6fa3] bg-clip-text text-transparent">
                                    {isLoading ? "..." : jobCount}
                                </dd>
                            </div>
                        </div>
            ...
            <div>
                <div className="scroll-animate scroll-fade-up flex items-center justify-between mb-8">
                    ...
                    <Link
                        href="/dashboard/jobs"
                        className="inline-flex items-center px-5 py-2.5 text-sm font-semibold text-[#4a4e69] bg-[#e8eef5] rounded-xl hover:bg-[#b8c5d6] hover:shadow-md transition-all duration-200 border border-[#b8c5d6]"
                    >
                        View all
